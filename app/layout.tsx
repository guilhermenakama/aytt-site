...
export const metadata: Metadata = {
  ...
  description:
    "Transforme seu negócio com times especializados em IA e automação. Sem escopo engessado, com resultados reais. Ideal para diretores e empresários que buscam eficiência operacional.",
  keywords: [
  ...
  creator: "AYTT",
  publisher: "AYTT",
  metadataBase: new URL("https://aytt.tech"),
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  openGraph: {
    ...
    description:
      "Alocação de times de IA e automação para empresas. Sem escopo engessado, com resultados reais. Transforme processos repetitivos em vantagem competitiva.",
    images: [
      {
        url: "/logo.png",
        width: 1200,
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                "Alocação de times especializados em IA e automação para empresas. Transformamos processos repetitivos em vantagem competitiva.",
              foundingDate: "2024",
              founders: [
                {
                  "@type": "Person",
              ...
              sameAs: ["https://instagram.com/aytt.tech", "https://wa.me/5543999108255"],
              serviceArea: {
                "@type": "Country",
                name: "Brasil",
              },
