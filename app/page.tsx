  ...
  export default function Home() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
      ...
      try {
        ...
        if (response.ok) {
          alert("E-mail enviado com sucesso! Entraremos em contato em breve.")
        ...
        alert("Erro ao enviar e-mail. Tente novamente ou entre em contato via WhatsApp.")
      } finally {
