...
export default function Home() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!consentimento) {
      alert("Por favor, aceite o Termo de Consentimento para continuar.")
      return
    }
...
Projeto de Automação: ${formData.projeto}

---
Enviado através do site AYTT
Data: ${new Date().toLocaleString("pt-BR")}
      `.trim()

      const mailtoLink = `mailto:guilhermenakama@sorai.net.br?subject=Contato AYTT - ${formData.empresa}&body=${encodeURIComponent(emailBody)}`
  ...
  const painPoints = [
    ...
    { icon: <Shuffle className="h-5 w-5 sm:h-6 sm:w-6" />, text: "O escopo mudou várias vezes e nada ficou claro" },
    {
      ...
      text: "A comunicação foi falha e sem alinhamento com o negócio",
    },
    {
      icon: <DollarSign className="h-5 w-5 sm:h-6 sm:w-6" />,
      text: "No fim, é você quem precisa lidar com o prejuízo",
    },
  ]
  ...
  const urgencyIndicators = [
    {
      ...
      text: "A pressão por eficiência e redução de custos está aumentando",
    },
    { icon: <Clock className="h-6 w-6 sm:h-8 sm:w-8" />, text: "Decisões precisam ser mais rápidas e assertivas" },
    {
      ...
      text: "Seus concorrentes já estão usando Inteligência Artificial ",
    },
  ...
  const solutionDifferentials = [
    ...
    { icon: <Target className="h-6 w-6 sm:h-8 sm:w-8" />, text: "Foco total em eficiência na alocação de talentos" },
    {
      ...
      text: "Contrato baseado em perfis, não em escopos fechados",
    },
  ...
  const practicalSolutions = [
    ...
    },
    {
      ...
      features: ["Responde comentário de posts", "Atendimento em DMs", "Esclarecimento de dúvidas de produtos"],
  ...
  const readyChecklist = [
    {
      icon: <Repeat className="h-5 w-5 sm:h-6 sm:w-6" />,
      text: "Tem processos repetitivos que consomem tempo da equipe",
    },
    {
      icon: <Brain className="h-5 w-5 sm:h-6 sm:w-6" />,
      text: "Sabe que precisa de IA, mas não sabe por onde começar",
    },
    ...
    <div className="relative bg-transparent text-white overflow-hidden">
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 flex items-center justify-between">
          ...
          >
            {isMenuOpen ? <X className="h-6 w-6 animate-spin" /> : <Menu className="h-6 w-6 hover:animate-pulse" />}
          </button>
        </div>
      </header>
          ...
          <div className="max-w-4xl mx-auto text-center animate-on-scroll">
            ...
            <div className="card p-6 sm:p-8 md:p-12 transform hover:scale-105 hover:border-blue-500/30 transition-all duration-500 group">
              <p className="text-base sm:text-lg md:text-xl text-gray-300 leading-relaxed mb-4 sm:mb-6 group-hover:text-white transition-colors duration-300">
                Aristóteles chamava de <em>phronesis</em> — a sabedoria prática que equilibra conhecimento técnico com
                bom senso humano.
              </p>
              <p className="text-base sm:text-lg md:text-xl text-gray-300 leading-relaxed mb-4 sm:mb-6 group-hover:text-white transition-colors duration-300">
                Não buscamos extremos: nem a paralisia da complexidade, nem a ilusão da simplicidade absoluta. Nosso
                foco é o meio-termo virtuoso entre inovação e prudência, entre ambição tecnológica e viabilidade real.
              </p>
              <p className="text-base sm:text-lg md:text-xl text-gray-300 leading-relaxed group-hover:text-white transition-colors duration-300">
                Porque a excelência não está em fazer o mais complexo possível, mas em fazer exatamente o que precisa
                ser feito.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="bg-gradient-to-r from-blue-900/20 to-blue-900/20 rounded-3xl p-6 sm:p-8 md:p-12 border border-white/10 animate-on-scroll transform hover:scale-105 transition-all duration-500">
            ...
            <p className="text-center text-gray-300 mb-6 sm:mb-8 text-sm sm:text-base">
              Nossos fundadores têm experiência em consultoria e serviços tecnológicos para empresas consolidadas no
              mercado:
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="card p-6 sm:p-8 md:p-12 mb-8 sm:mb-12 animate-on-scroll transform hover:scale-105 hover:border-blue-500/30 transition-all duration-500 group">
              <p className="text-base sm:text-lg text-gray-300 leading-relaxed mb-4 sm:mb-6 group-hover:text-white transition-colors duration-300">
                Eles envolvem elementos com output probabilístico (IA) e maior incerteza técnica. Ao projetar uma
                arquitetura de solução com IA, é fundamental compreender as limitações e potencialidades para garantir
                desempenho, escalabilidade e viabilidade financeira.
              </p>
            ...
            <div className="text-center animate-on-scroll">
              ...
              <div className="card-info p-6 sm:p-8 transform hover:scale-105 hover:border-blue-500/30 transition-all duration-500 group">
                <p className="text-base sm:text-lg md:text-xl text-gray-300 leading-relaxed mb-4 sm:mb-6 group-hover:text-white transition-colors duration-300">
                  Na AYTT, desenvolvemos uma abordagem que separa elementos determinísticos dos probabilísticos, criando
                  arquiteturas modulares com agentes especializados.
                </p>

                <p className="text-lg sm:text-xl font-semibold text-white">Veja a diferença na prática:</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section
        id="architecture"
        ref={architectureRef}
        className="py-16 sm:py-24 relative aytt-bg-accent texture-concrete"
      >
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-12 sm:mb-16 animate-on-scroll">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 sm:mb-6">
          ...
          <div className="text-center max-w-3xl mx-auto px-4 sm:px-6 mb-28 sm:mb-32 md:mb-36 lg:mb-40 animate-on-scroll">
            <p className="text-lg sm:text-xl text-gray-300 leading-relaxed">
              Veja algumas aplicações práticas, pensadas para gerar{" "}
              <strong className="text-white">valor real no dia a dia da sua empresa.</strong>
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 max-w-5xl mx-auto">
            <div className="card p-6 sm:p-8 animate-on-scroll transform hover:scale-105 hover:border-blue-500/30 transition-all duration-500">
              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-400 mb-2">Projeto de Automação *</label>
                  <textarea
                    rows={4}
                    name="projeto"
                ...
                <div className="flex items-start gap-3">
                  <input
                    ...
                    required
                  />
                  <label htmlFor="consentimento" className="text-sm text-gray-300">
                    Concordo com o{" "}
                    <button
                      type="button"
                ...
                <div className="space-y-3 sm:space-y-4">
                  {[
                    ...
                    >
                      ...
                      <p className="text-gray-400 text-sm sm:text-base hover:text-white transition-colors duration-300">
                        {item}
                      </p>
                    </div>
                  ))}
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center">
            ...
            <div className="border-t border-white/10 pt-6 sm:pt-8 animate-on-scroll">
              ...
              <p className="text-gray-500 text-xs sm:text-sm mt-2 animate-pulse">Clareza • Transparência • Resultado</p>
            </div>
          </div>
        </div>
      </footer>
        ...
        <div className="fixed inset-0 z-50 bg-black/80 flex items-center justify-center p-4">
          <div className="card border border-white/20 rounded-lg max-w-4xl max-h-[80vh] overflow-y-auto">
            <div className="sticky top-0 bg-grafitti-gradient border-b border-white/20 p-4 flex justify-between items-center">
              ...
              <button onClick={() => setShowConsentTerm(false)} className="text-gray-400 hover:text-white">
                ✕
              </button>
            </div>
            <TermoConsentimento />
